...
const productUrl = String(process.env.VUE_APP_API_PRODUCT);
const loginUrl = String(process.env.VUE_APP_API_LOGIN);
const adminUrl = String(process.env.VUE_APP_API_ADMIN);
